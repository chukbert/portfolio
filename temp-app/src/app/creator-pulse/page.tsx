...
export default function CreatorPulseShowcase() {
    ...
    return (
        <main style={{ minHeight: "100vh", background: "var(--bone)", color: "var(--ink)" }}>
            ...
            >
                <div className="wrap flex items-center justify-between" style={{ height: "64px" }}>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a href="https://github.com/chukbert/creator-pulse" target="_blank" rel="noopener noreferrer" className="nav-btn">
                            View Source ↗
                        </a>
                    </div>
                </div>
                    ...
                    <motion.div variants={staggerContainer} initial="hidden" animate={isHeroInView ? "visible" : "hidden"}>
                        ...
                        <div style={{ display: "grid", gap: "3rem", alignItems: "center" }} className="md:grid-cols-12">
                            <div className="md:col-span-7">
                                ...
                                <motion.div variants={fadeInUp}>
                                    ...
                                    <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
                                        {["Elixir", "Phoenix", "Nuxt 3", "Vue 3", "PostgreSQL", "Claude Code"].map((tech) => (
                                            <span key={tech} style={{
                            ...
                            <motion.div className="md:col-span-5" variants={fadeInUp} style={{
                                ...
                                <img src="/images/creator-pulse/thumbnail.png" alt="Creator Pulse Preview" style={{ width: "100%", height: "auto", display: "block" }} />
            ...
            {/* Velocity / AI-Augmented Engineering Section */}
                ...
                <div className="wrap">
                    <motion.div variants={scrollReveal} initial="hidden" whileInView="visible" viewport={{ once: true }} style={{ textAlign: "center", maxWidth: "80ch", margin: "0 auto", marginBottom: "clamp(3rem, 6vw, 5rem)" }}>
                        ...
                        <h2 style={{ fontSize: "clamp(2rem, 5vw, 4rem)", fontWeight: 800, letterSpacing: "-0.04em", color: "var(--ink)", lineHeight: 1.05, marginBottom: "2rem" }}>
                            Accelerating Development with <span style={{ color: "var(--vermillion)" }}>Claude Code</span>
                        </h2>
                        <p style={{ fontSize: "1.15rem", color: "var(--fog)", lineHeight: 1.7, marginBottom: "0" }}>
                            I heavily utilized <strong>Claude Code</strong> to scaffold the Elixir/Phoenix backend, write Ecto migrations, generate AI Text-to-SQL logic, and mock over 10,000 realistic transaction records. This allowed me to focus on high-level architecture rather than repetitive boilerplate.
                        </p>
                    </motion.div>
                        ...
                        <div className="md:col-span-6">
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                                <p style={{ fontSize: "1.05rem", color: "var(--fog)", lineHeight: 1.72 }}>
                                    The standout feature is the <strong>"Chat with Your Data"</strong> capability. Built on top of Elixir/Phoenix and <strong>OTP/GenServers</strong>, it enables creators to type natural language queries which are securely transformed into SQL.
                                </p>
                                <p style={{ fontSize: "1.05rem", color: "var(--fog)", lineHeight: 1.72 }}>
                            ...
                            <div className="card" style={{ padding: "clamp(1.25rem, 2.5vw, 2rem)", background: "var(--bone)" }}>
                                <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem", fontFamily: "var(--font-mono)", fontSize: "0.72rem", lineHeight: 1.4 }}>
                                    <div style={{ border: "1px solid var(--rule-light)", padding: "0.75rem", borderRadius: "4px" }}>
                                        <p style={{ color: "var(--vermillion)", fontWeight: 700, marginBottom: "0.25rem" }}>01 USER INTENT</p>
                                        <p style={{ color: "var(--fog)" }}>Input: "How many templates did I sell last week?"</p>
                                    </div>
                                    ...
                                    <div style={{ border: "1px solid var(--rule-light)", padding: "0.75rem", borderRadius: "4px", background: "rgba(14,13,10,0.02)" }}>
                                        <p style={{ color: "var(--ink)", fontWeight: 700, marginBottom: "0.25rem" }}>02 LLM TRANSLATION (Elixir Backend)</p>
                                        <p style={{ color: "var(--fog)" }}>Output: SELECT COUNT(*) FROM transactions ...</p>
                                    </div>
                                    <div style={{ textAlign: "center", color: "var(--rule-light)", height: "12px", lineHeight: "12px" }}>▼</div>
                                    <div style={{ border: "1px solid var(--rule-light)", padding: "0.75rem", borderRadius: "4px" }}>
                                        <p style={{ color: "var(--vermillion)", fontWeight: 700, marginBottom: "0.25rem" }}>03 SECURE EXECUTION</p>
                                        <p style={{ color: "var(--fog)" }}>PostgreSQL evaluates via read-only `analytics_reader` role</p>
                                    </div>
                                    <div style={{ textAlign: "center", color: "var(--rule-light)", height: "12px", lineHeight: "12px" }}>▼</div>
                                    <div style={{ border: "1px solid var(--vermillion)", padding: "1rem", borderRadius: "4px", background: "rgba(235, 87, 87, 0.03)" }}>
                                        <p style={{ color: "var(--ink)", fontWeight: 700, marginBottom: "0.75rem", fontSize: "0.8rem" }}>04 DYNAMIC CHARTING (Vue 3)</p>
                                        <p style={{ color: "var(--fog)", fontSize: "0.65rem" }}>JSON Payload delivered → Chart.js rendering</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            {[
                {
                    num: "01", title: "Public Storefront (Nuxt 3 SSR)", subtitle: "SEO-Optimized Performance",
                    desc: "A high-performance, Server-Side Rendered (SSR) public storefront built in Nuxt 3 designed to display creator digital products. The SSR architecture ensures critical SEO signals are present upon first load, driving better organic discovery.",
                    feats: ["SSR for optimal SEO", "Nuxt 3 dynamic routing", "Responsive layout", "Fast initial load speeds"],
                    img: "/images/creator-pulse/store_front.png", reverse: false
                },
                {
                    num: "02", title: "Creator Product Listings", subtitle: "Dynamic Store Configurations",
                    desc: "Allows creators to manage multiple digital items such as e-books, templates, and courses. Each product has tailored pricing and variant logic handled cleanly through Elixir backend endpoints.",
                    feats: ["Granular control over e-books, courses, templates", "Dynamic product configuration", "Elixir-curated rapid API response", "Clean UI/UX flow"],
                    img: "/images/creator-pulse/example_store_of_a_creator.png", reverse: true
                },
                {
                    num: "03", title: "Checkout Flow UI", subtitle: "Conversion-Focused Transactions",
                    desc: "A frictionless checkout experience engineered with modern Vue 3 components, tracking real-time purchase data into the `transactions` table. Essential for collecting the business metrics fed directly into the Text-to-SQL logic.",
                    feats: ["Responsive checkout interface", "High-conversion design patterns", "Immutable transaction logging", "Ecto state management"],
                    img: "/images/creator-pulse/payment_page_for_a_product.png", reverse: false
                },
                {
                    num: "04", title: "Private Creator Dashboard", subtitle: "Vue 3 SPA Real-Time Analytics",
                    desc: "A fast Single Page Application built utilizing Vue 3's Composition API. Features real-time dashboard navigations tracking daily and monthly revenue metrics without full page reloads, ensuring optimal creator experience.",
                    feats: ["Vue 3 Composition API", "Interactive dashboard components", "Daily/monthly revenue metrics", "Fluid SPA navigation"],
                    img: "/images/creator-pulse/dashboard_for_creator.png", reverse: true
                },
                {
                    num: "05", title: "“Chat with Your Data” AI Consultant", subtitle: "Autonomous Database Interrogation",
                    desc: "The flagship feature. Users ask questions like “What were my sales by product?” and an AI translates this into SQL, executes it, and renders a dynamic visualization. Features GenServer caching and highly indexed queries.",
                    feats: ["Natural Language to SQL", "Gemini API integration", "OTP/GenServers for query caching", "Dynamic chart (bar, line, pie) rendering"],
                    img: "/images/creator-pulse/ai_chatbot.png", reverse: false
                }
            ].map((f, idx) => (
                <FeatureSection
                ...
                <div className="wrap">
                    ...
                    <motion.div variants={staggerContainer} initial="hidden" animate={isTechInView ? "visible" : "hidden"} style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(140px, 1fr))", gap: "0.75rem" }}>
                        {[
                            ...
                            { name: "Nuxt 3", category: "Public UI (SSR)" },
                            { name: "Vue 3", category: "Dashboard (SPA)" },
                            { name: "PostgreSQL", category: "Database" },
                            { name: "Ecto", category: "ORM" },
                            { name: "Gemini API", category: "AI LLM" },
                            { name: "Claude Code", category: "AI Dev Workflow" },
                            { name: "OTP/GenServers", category: "Concurrency" },
            ...
            <footer style={{ padding: "2rem 0", borderTop: "1px solid var(--rule-light)", background: "var(--surface)" }}>
                <div className="wrap" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
                    ...
                    <p style={{ fontFamily: "var(--font-mono)", fontSize: "0.72rem", color: "var(--fog)", letterSpacing: "0.1em", textAlign: "center", flex: "1 0 100%", marginTop: "1.5rem", opacity: 0.8 }}>
                        © {new Date().getFullYear()} CREATOR PULSE. ALL RIGHTS RESERVED.<br />
